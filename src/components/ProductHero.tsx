...
const ProductHero: React.FC<ProductHeroProps> = ({
  ...
  return (
    <div className="relative min-h-[60vh] sm:min-h-[80vh] flex items-end justify-start overflow-hidden md:px-20">
      ...
      <div className="relative z-10 sm:max-w-section px-4 pb-20 w-full">
        <div className="">
          ...
          <p
            className="text-lg md:text-xl lg:text-2xl font-light text-white/90 mb-8 animate-fade-in-up"
