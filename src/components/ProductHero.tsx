...
const ProductHero: React.FC<ProductHeroProps> = ({
  ...
  return (
    <div className="relative min-h-[60vh] sm:min-h-[80vh] flex items-end justify-start overflow-hidden">
      ...
      <div className="relative z-10 max-w-section mx-auto pt-20 pb-20 w-full">
        <div className="">
          ...
          <p
            className="text-lg md:text-xl lg:text-2xl font-light text-white/90 mb-8 animate-fade-in-up md:line-clamp-none"
